...
function loadSecrets(): Record<string, string> { return JSON.parse(readFileSync(join(getAgentDir(), "security.json"), "utf8")); }
...
export default function createMcpExtension(agent?: string): InlineExtension {
